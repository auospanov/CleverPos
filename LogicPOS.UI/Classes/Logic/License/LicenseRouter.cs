    ...
    public class LicenseRouter
    {
        ...
        public LicenseRouter()
        {
            ...
            else
            {
                ...
                byte[] registredLicence = PluginSettings.LicenceManager.GetLicence(
                    HardwareId,
                    version,
                    hasLicense,
                    File.ReadAllBytes(POSSettings.LicenceFileName),
                ...
                if (registredLicence.Length > 0)
                {
                    ...
                    WriteByteArrayToFile(registredLicence, POSSettings.LicenceFileName);
