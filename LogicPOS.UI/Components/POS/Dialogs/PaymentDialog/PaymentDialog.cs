    ...
    internal partial class PaymentDialog : PosBaseDialog
    {
            ...
            : base(pSourceWindow, pDialogFlags, false)
        {
            try
            {
                ...
                fin_configurationpaymentmethod xpoCreditCard = ResolvePaymentMethodButton(xPSelectData, "KASPI_CARD", "HALYK_CARD", "JUSAN_CARD", "CREDIT_CARD");
                /* IN009142 - "Visa" option replaced by "Debit Card" / Kaspi/Halyk/Jusan QR for KZ */
                fin_configurationpaymentmethod xpoDebitCard = ResolvePaymentMethodButton(xPSelectData, "KASPI_QR", "HALYK_QR", "JUSAN_QR", "DEBIT_CARD");
