inherited ClientListForm: TClientListForm
  ...
  object pn1: TPanel [3]
    ...
    object tlClientCategory: TcxDBTreeList
      ...
      object clmnGrp: TcxDBTreeListColumn
  ...
  inherited spDel: TpFIBStoredProc
    SQL.Strings = (
        ...
        'EXECUTE PROCEDURE G_DEL_G_CLIENT (?G_CLIENT_, ?USER_ID_, ?LOG_BO' +
        'DY_)')
  ...
  object spClientHis: TpFIBDataSet
    SelectSQL.Strings = (
        ...
        'SELECT * FROM G_READ_CLIENT_HIS(:g_client_,:DO_NOT_SHOW_RASHODNI' +
        'KI_)')
    Transaction = tranRead
    Database = MainDM.dbMain
    Left = 656
