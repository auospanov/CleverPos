inherited ProdazhaTovaraListForm: TProdazhaTovaraListForm
  ...
  inherited gr1: TcxGrid
    ...
    inherited tvMain: TcxGridDBTableView
      ...
      DataController.Summary.FooterSummaryItems = <
        ...
        item
          Kind = skSum
          Column = clmMainSUMM_CASH
        end
        item
          Kind = skSum
          Column = clmMainSUMM_NONCASH
        end>
  ...
  object grZakazDetails: TcxGrid [3]
    ...
    object tvDetails: TcxGridDBTableView
      PopupMenu = pmGridDetails
      OnMouseDown = tvDetailsMouseDown
      ...
      object clmOstatokSklad: TcxGridDBColumn
        Caption = #1054#1089#1090#1072#1090#1086#1082' '#1085#1072' '#1089#1082#1083#1072#1076#1077
        DataBinding.FieldName = 'OSTATOK_SKLAD'
        Visible = False
        HeaderAlignmentHorz = taCenter
        Width = 112
      end
      object clmDetailsPRICE_ROZN: TcxGridDBColumn
      ...
      object clmDetailsPRICE_OPT: TcxGridDBColumn
  ...
  inherited dxBarManagerChild: TdxBarManager
    ...
    object sbiCheck: TdxBarSubItem
      ...
      ItemLinks = <
        item
          Visible = True
          ItemName = 'btnPrintOnPrinter'
        end
        item
          Visible = True
          ItemName = 'btnPrintOnFr'
        end>
    end
    object btnPrintOnPrinter: TdxBarButton
      Caption = #1055#1088#1080#1085#1090#1077#1088' '#1095#1077#1082#1086#1074
      Category = 0
      Visible = ivAlways
      OnClick = btnPrintOnPrinterClick
    end
    object btnPrintOnFr: TdxBarButton
  ...
  object spZakazDetails: TpFIBDataSet
    SelectSQL.Strings = (
        ...
        'SELECT * FROM READ_ZAKAZ_DETAILS_LIST(?ZAKAZ_, ?IS_SPISANIE_, ?H' +
        'AVE_RIGHT_TO_SEE_COST_PRICE_)')
  ...
  object pmGridDetails: TPopupMenu
    Left = 16
    Top = 288
