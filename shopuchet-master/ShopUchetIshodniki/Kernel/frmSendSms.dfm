inherited SendSmsForm: TSendSmsForm
  ...
  object mdClient: TdxMemData
    Indexes = <>
    SortOptions = []
    OnCalcFields = mdClientCalcFields
    Left = 280
    Top = 480
    ...
    object mdClientStatus: TIntegerField
      FieldName = 'Status'
    end
    object mdClientSmsText: TStringField
      FieldKind = fkCalculated
      FieldName = 'SmsText'
      Calculated = True
    end
    object mdClientID: TBCDField
      FieldName = 'ID'
      Size = 0
    end
  end
