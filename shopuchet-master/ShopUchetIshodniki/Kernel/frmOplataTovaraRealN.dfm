inherited OplataTovaraRealNForm: TOplataTovaraRealNForm
  Caption = 'OplataTovaraRealNForm'
  ClientWidth = 495
  ExplicitWidth = 501
  ExplicitHeight = 240
  PixelsPerInch = 96
  ...
  inherited spIns: TpFIBStoredProc
    SQL.Strings = (
        ...
        'NOTE_, ?SUMM_, ?SUMM_FACT_, ?UPLOAD_TO_EXT_APP_)')
  ...
  inherited spUpd: TpFIBStoredProc
    SQL.Strings = (
        ...
        'SPISANIE_, ?SUMM_, ?SUMM_FACT_, ?UPLOAD_TO_EXT_APP_)')
