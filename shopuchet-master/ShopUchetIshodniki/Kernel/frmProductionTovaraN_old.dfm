object ProductionTovaraNForm: TProductionTovaraNForm
  Left = 713
  Top = 180
  ...
  object Panel1: TPanel
    ...
    object peTovar: TdxPopupEdit
      Left = 182
      Top = 94
      Width = 372
      Hint = #1042#1099#1073#1077#1088#1080#1090#1077' '#1087#1088#1086#1076#1091#1082#1090', '#1082#1086#1090#1086#1088#1099#1081' '#1093#1086#1090#1080#1090#1077' '#1087#1088#1086#1080#1079#1074#1077#1089#1090#1080
      ParentShowHint = False
      ShowHint = True
      TabOrder = 3
      Anchors = [akLeft, akTop, akRight]
      PopupControl = PopupTovListForm.pnlMain
      OnCloseUp = peTovarCloseUp
      OnInitPopup = peTovarInitPopup
    end
  ...
  object spReadSost: TpFIBDataSet
    SelectSQL.Strings = (
      ...
      '      ,g.name||'#39' - '#39'||CAST(k.amount as varchar(10)) Name'
      '  from g_product_kit k'
      '       ,g_product g'
      ' where k.g_product = :g_product_'
