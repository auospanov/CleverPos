...
type
  TDBMultiPageListROForm = class(TMDIChildForm)
    ...
    riEditRepositoryCurrencyItem1: TcxEditRepositoryCurrencyItem;
    riEditRepositoryCurrencyItem: TcxEditRepositoryCalcItem;
...
begin
  ...
  riEditRepositoryCurrencyItem := SetColumnDecimalPlace(riEditRepositoryCurrencyItem);
