...
uses
  ...
  dxBarBuiltInMenu, System.Actions, dxSkinBlueprint, dxSkinDevExpressDarkStyle,
...
begin
  ...
  if FKeyFieldIsStr then begin
    ...
    FClassForm.RecID := ActiveDataSet.FieldByName(FKeyFieldList).AsLargeInt;
    FClassForm.RecIDStr := '';
  end;
  ...
  if FParentKeyFieldIsStr then begin
    ...
    (FClassForm as TDBTreeEditForm).ParentRecID := ActiveDataSet.FieldByName(FParentKeyFieldList).AsLargeInt;
...
begin
  ...
  try
    ...
    if FParentKeyFieldIsStr then begin
      ...
      (FClassForm as TDBTreeEditForm).ParentKeyFieldIsStr := False;
      (FClassForm as TDBTreeEditForm).ParentRecID := ActiveDataSet.FieldByName(FKeyFieldList).AsLargeInt;
      (FClassForm as TDBTreeEditForm).ParentRecIDStr := '';
    end;
