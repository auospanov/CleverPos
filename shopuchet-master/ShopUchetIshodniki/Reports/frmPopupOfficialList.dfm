inherited PopupOfficialListForm: TPopupOfficialListForm
  Left = 523
  Top = 276
  ...
  inherited spRead: TpFIBDataSet
    SelectSQL.Strings = (
      ...
      '       NAME,'
      '       KOD'
      '  FROM (SELECT G.G_OFFICIAL ID,'
      
        '               COALESCE(G.FM, '#39#39')||COALESCE('#39' '#39'||G.NM, '#39#39')||COAL' +
        'ESCE('#39' '#39'||G.FT,  '#39#39') NAME,'
      '               G.KOD'
      '          FROM G_OFFICIAL G'
      '         WHERE G.IS_ACTIVE = 1'
      '        ORDER BY G.IS_ISPOLNITEL DESC, G.FM, G.NM, G.FT)')
  end
