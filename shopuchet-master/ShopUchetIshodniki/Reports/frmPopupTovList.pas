...
procedure TPopupTovListForm.edBarcodeFocusChanged(Sender: TObject);
begin
  inherited;
...
procedure TPopupTovListForm.edBarcodeKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  if Key = VK_UP then
    spRead.Prior
...
procedure TPopupTovListForm.edBarcodePropertiesChange(Sender: TObject);
begin
