inherited ClientDateFilterForm: TClientDateFilterForm
  ...
  inherited Panel1: TPanel
    ...
    object PageControl: TcxPageControl
      ...
      Align = alClient
      TabOrder = 0
      Properties.ActivePage = tsSetNewPrices
      ...
      object tsDates: TcxTabSheet
        ...
        object pnlSalaryMode: TPanel
          ...
          object cbSalaryMode: TcxComboBox
            Left = 112
            Top = 5
            Margins.Left = 2
            Margins.Top = 2
            ...
            Properties.Items.Strings = (
              ...
              #1055#1086' '#1075#1088#1091#1087#1087#1072#1084' '#1090#1086#1074#1072#1088#1086#1074)
            Style.BorderStyle = ebsFlat
            Style.ButtonTransparency = ebtNone
            TabOrder = 0
            Text = #1044#1077#1090#1072#1083#1100#1085#1086
            Width = 205
          end
        end
        object pnlTovarCategory: TPanel
          Left = 143
          Top = 295
          Width = 375
          Height = 29
          ...
          object cbTovarCategory: TCheckBox
            Left = 327
            Top = 8
            Width = 41
            Height = 17
            ...
            State = cbChecked
            TabOrder = 0
            OnClick = cbTovarCategoryClick
          end
          object leTovarCategory: TcxLookupComboBox
            Left = 112
            Top = 4
            Margins.Left = 2
            Margins.Top = 2
        ...
        object cbMakeBySF: TcxCheckBox
          Left = 145
          Top = 400
          Hint = 
            #1055#1086#1089#1090#1072#1074#1100#1090#1077' '#1075#1072#1083#1086#1095#1082#1091', '#1095#1090#1086#1073#1099' '#1089#1092#1086#1088#1084#1080#1088#1086#1074#1072#1090#1100' '#1072#1082#1090' '#1089#1074#1077#1088#1082#1080' '#1087#1086' '#1089#1092#1086#1088#1084#1080#1088#1086#1074#1072#1085#1085 +
            #1099#1084#13#10#1089#1095#1077#1090#1072#1084' '#1092#1072#1082#1090#1091#1088#1072#1084' '#1087#1086' '#1082#1083#1080#1077#1085#1090#1091'.'
          Caption = #1060#1086#1088#1084#1080#1088#1086#1074#1072#1090#1100' '#1072#1082#1090' '#1089#1074#1077#1088#1082#1080' '#1087#1086' '#1057#1060' '#1074#1099#1073#1088#1072#1085#1085#1086#1081' '#1092#1080#1088#1084#1099
          ParentShowHint = False
          ShowHint = True
          Style.StyleController = dxEditStyleController
          TabOrder = 11
        ...
        object pnlExcludeStatyaPrihod: TPanel
          Left = 143
          Top = 287
          Width = 375
          Height = 63
          ...
          object leExcludeStatya: TcxLookupComboBox
            Left = 6
            Top = 32
            Margins.Left = 2
            Margins.Top = 2
            ...
            Properties.ListOptions.ShowHeader = False
            Properties.ListSource = dsExcludeStatya
            Style.BorderStyle = ebsFlat
            Style.ButtonTransparency = ebtNone
            TabOrder = 0
            Width = 311
          end
          object cbExcludeStatya: TcxCheckBox
            Left = -1
            Top = 8
            Caption = #1053#1077' '#1074#1082#1083#1102#1095#1072#1090#1100' '#1089#1090#1072#1090#1100#1080' '#1087#1088#1080#1093#1086#1076#1072' '#1074' '#1082#1072#1089#1089#1091
            ParentShowHint = False
            Properties.OnChange = cbExcludeStatysAllPropertiesChange
            ShowHint = True
            Style.StyleController = dxEditStyleController
            TabOrder = 1
            Width = 344
          end
          object cbExcludeStatyaAll: TcxCheckBox
            Left = 325
            Top = 32
            Caption = #1042#1089#1077
            Enabled = False
            ParentShowHint = False
            Properties.OnChange = cbExcludeStatyaAllPropertiesChange
            ShowHint = True
            State = cbsChecked
            Style.StyleController = dxEditStyleController
            TabOrder = 2
      ...
      object tsSetNewPrices: TcxTabSheet
        ...
        Margins.Right = 2
        Margins.Bottom = 2
        Caption = #1059#1089#1083#1086#1074#1080#1103' '#1080#1079#1084#1077#1085#1077#1085#1080#1103' '#1090#1086#1074#1072#1088#1086#1074
        ImageIndex = 2
        ...
        object cbCnahgeSalesComm: TcxCheckBox
          Left = 66
          Top = 289
          Caption = #1048#1079#1084#1077#1085#1080#1090#1100' '#1087#1088#1086#1094#1077#1085#1090' '#1087#1088#1086#1076#1072#1074#1094#1072
          Properties.MultiLine = True
          Properties.OnChange = cbCnahgeSalesCommPropertiesChange
          Style.StyleController = dxEditStyleController
          TabOrder = 11
          Width = 201
        end
        ...
        object cbChangeKitTypeCheckBox: TcxCheckBox
          Left = 66
          Top = 325
          Caption = #1048#1079#1084#1077#1085#1080#1090#1100' '#1090#1080#1087' '#1090#1086#1074#1072#1088#1072
          Properties.MultiLine = True
          Properties.OnChange = cbChangeKitTypeCheckBoxPropertiesChange
          Style.StyleController = dxEditStyleController
          TabOrder = 13
          Width = 201
        end
        object cbChagneKitType: TcxComboBox
          Left = 295
          Top = 325
          Enabled = False
          Properties.DropDownListStyle = lsFixedList
          Properties.Items.Strings = (
            ''
            #1089' "'#1053#1072#1073#1086#1088' ('#1089#1086#1089#1090#1072#1074#1085#1086#1081')" '#1085#1072' "'#1043#1086#1090#1086#1074#1099#1081' '#1087#1088#1086#1076#1091#1082#1090'"')
          Properties.OnChange = cb1PropertiesChange
          Style.StyleController = dxEditStyleController
          TabOrder = 14
          Text = #1089' "'#1053#1072#1073#1086#1088' ('#1089#1086#1089#1090#1072#1074#1085#1086#1081')" '#1085#1072' "'#1043#1086#1090#1086#1074#1099#1081' '#1087#1088#1086#1076#1091#1082#1090'"'
          Width = 344
        end
        object cbKaspiCheckBox: TcxCheckBox
          Left = 66
          Top = 361
          Caption = #1042#1099#1075#1088#1091#1078#1072#1090#1100' '#1074' Kaspi '#1052#1072#1075#1072#1079#1080#1085
          Properties.MultiLine = True
          Properties.OnChange = cbKaspiCheckBoxPropertiesChange
          Style.StyleController = dxEditStyleController
          TabOrder = 15
          Width = 201
        end
        object cbKaspi: TcxComboBox
          Left = 295
          Top = 361
          Enabled = False
          Properties.DropDownListStyle = lsFixedList
  ...
  object spExcludeStatya: TpFIBDataSet
    SelectSQL.Strings = (
      'SELECT *'
      'FROM G_PRIHOD_RASHOD G'
      'WHERE G.DO_ACTION = 0'
      'AND G.G_PRIHOD_RASHOD NOT IN (1, 2, 3)'
      'ORDER BY G.NAME')
    Transaction = tranRead
    Database = MainDM.dbMain
    Left = 600
  ...
  object dsExcludeStatya: TDataSource
    DataSet = spExcludeStatya
    Left = 632
    Top = 312
  end
end
