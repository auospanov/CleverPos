...
uses
  ...
  cxClasses, cxButtons, cxEditRepositoryItems;
...
type
  ...
  public
    ...
    property pePostavshikTag : Int64 read FpePostavshikTag write FpePostavshikTag;
  end;
...
begin
  if FPopupCLIENTForm.AcceptRes then begin
    FpePostavshikTag := FPopupCLIENTForm.spRead.FieldByName('ID').AsLargeInt;
