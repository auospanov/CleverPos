...
uses
  ...
  frmUpgradeDB in '..\Shared\frmUpgradeDB.pas' {UpgradeDBForm},
  ...
  frmSync in '..\Kernel\frmSync.pas' {SyncForm},
  ...
  frmAddPrihodList in '..\Kernel\frmAddPrihodList.pas' {AddPrihodListForm};
