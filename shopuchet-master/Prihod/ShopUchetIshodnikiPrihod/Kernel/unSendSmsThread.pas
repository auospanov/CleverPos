      ...
      with MainDM.spThreadReadSmsRecipients do begin
        while not EOF do begin
          if IsDebugHook = 0 then
            ret := sms.send_sms(FieldByName('phone').AsString , FieldByName('Smstext').AsString, 0, FieldByName('TIME_TO_SEND').AsString)
          else begin
          ...
          try
            ...
            MainDM.spThreadInsSmsHistory.ParamByName('TEXT_').AsString := FieldByName('SmsTEXT').AsString;
