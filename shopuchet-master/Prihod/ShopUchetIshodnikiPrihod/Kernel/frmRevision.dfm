  ...
  inherited spRead: TpFIBDataSet
    SelectSQL.Strings = (
      ...
      '           R.AMOUNT_REAL - R.AMOUNT_BD DIFF_SUMM,'
        ...
        'CASE WHEN (R.AMOUNT_REAL - R.AMOUNT_BD) > 0 THEN G.PRICE*(R.AMOU' +
        'NT_REAL - R.AMOUNT_BD) ELSE 0 END OVER_SUMM,'
      
        '       CASE WHEN (R.AMOUNT_REAL - R.AMOUNT_BD) < 0 THEN G.PRICE*' +
        '(R.AMOUNT_BD - R.AMOUNT_REAL) ELSE 0 END LOSS_SUMM'
