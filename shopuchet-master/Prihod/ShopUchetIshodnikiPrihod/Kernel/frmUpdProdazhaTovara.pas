...
type
  ...
  public
    ...
    property OSTATOK: Integer read FOSTATOK write FOSTATOK;
  protected
...
begin
  ...
  with SP do begin
    if OpenMode = omInsert then
      ParamByName('G_PRODUCT_').AsInteger := FG_product;
...
begin
  ...
  if OpenMode in [omInsert] then begin
    ...
    spIsHaveDiscount.ParamByName('g_product_').AsInteger := FG_product;
