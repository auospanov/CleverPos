...
begin
  ...
  if OpenMode in [omView, omUpdate, omInsertLike] then begin
    with spGetData do begin
      leAddressType.EditValue := ParamByName('G_ADDRESS_TYPE_').AsInteger;
...
begin
  inherited;
  with SP do begin
    ParamByName('G_ADDRESS_TYPE_').AsInteger := leAddressType.EditValue;
