...
--
-- BarCode в демо пустой (NULL): синтетические EAN не генерируем; GTIN в НКТ — только при наличии реальному коду.
-- Excel-импорт BackOffice пока BarCode не пишет (задача C-1).
...
INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000001-0000-4000-8000-000000000001', 1001, 'TOP-001', 'Топ', NULL, 'Assets/Images/Products/Shop/TOP-001-top-beige.jpg',
  ...
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 8800, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='TOP-001');

INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000002-0000-4000-8000-000000000002', 1002, 'TS-001', 'Футболка', NULL, 'Assets/Images/Products/Shop/TS-001-tshirt-blue-glitter.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  ...
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 12800, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='TS-001');

INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000003-0000-4000-8000-000000000003', 1003, 'BL-001', 'Блуза', NULL, 'Assets/Images/Products/Shop/BL-001-blouse-white-pearl.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  ...
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 15000, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='BL-001');

INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000004-0000-4000-8000-000000000004', 1004, 'BL-002', 'Блуза', NULL, 'Assets/Images/Products/Shop/BL-002-blouse-print-rhinestone.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  (SELECT sf.Oid FROM fin_articlesubfamily sf JOIN fin_articlefamily f ON sf.Family=f.Oid WHERE f.Designation='Женское' AND sf.Designation='Блуза' LIMIT 1),
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 15000, 1, 0, datetime('now'), datetime('now')
...
INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000005-0000-4000-8000-000000000005', 1005, 'BL-003', 'Блуза', NULL, 'Assets/Images/Products/Shop/BL-003-blouse-peplum-white.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  (SELECT sf.Oid FROM fin_articlesubfamily sf JOIN fin_articlefamily f ON sf.Family=f.Oid WHERE f.Designation='Женское' AND sf.Designation='Блуза' LIMIT 1),
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 15000, 1, 0, datetime('now'), datetime('now')
...
INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000006-0000-4000-8000-000000000006', 1006, 'BL-004', 'Блуза', NULL, 'Assets/Images/Products/Shop/BL-004-blouse-abstract-blue.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  (SELECT sf.Oid FROM fin_articlesubfamily sf JOIN fin_articlefamily f ON sf.Family=f.Oid WHERE f.Designation='Женское' AND sf.Designation='Блуза' LIMIT 1),
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 15000, 1, 0, datetime('now'), datetime('now')
...
INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000007-0000-4000-8000-000000000007', 1007, 'RS-001', 'Рубашка', NULL, 'Assets/Images/Products/Shop/RS-001-shirt-stripe-blue.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  ...
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 14000, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='RS-001');

INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000008-0000-4000-8000-000000000008', 1008, 'BK-001', 'Накидка', NULL, 'Assets/Images/Products/Shop/BK-001-wrap-hood-white.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
...
INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000009-0000-4000-8000-000000000009', 1009, 'K2-001', 'Костюм с брюками', NULL, 'Assets/Images/Products/Shop/K2-001-suit-print-bw.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  ...
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 40000, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='K2-001');

INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000010-0000-4000-8000-000000000010', 1010, 'K2-002', 'Костюм с брюками', NULL, 'Assets/Images/Products/Shop/K2-002-suit-white-summer.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  (SELECT sf.Oid FROM fin_articlesubfamily sf JOIN fin_articlefamily f ON sf.Family=f.Oid WHERE f.Designation='Женское' AND sf.Designation='Костюм с брюками' LIMIT 1),
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 30000, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='K2-002');

INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000011-0000-4000-8000-000000000011', 1011, 'PJ-001', 'Пиджак', NULL, 'Assets/Images/Products/Shop/PJ-001-blazer-dark.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  ...
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 28000, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='PJ-001');

INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000012-0000-4000-8000-000000000012', 1012, 'BR-001', 'Брюки', NULL, 'Assets/Images/Products/Shop/BR-001-pants-brown-vishnya.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  ...
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 13000, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='BR-001');

INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000013-0000-4000-8000-000000000013', 1013, 'BR-002', 'Брюки', NULL, 'Assets/Images/Products/Shop/BR-002-pants-denim-marya.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  (SELECT sf.Oid FROM fin_articlesubfamily sf JOIN fin_articlefamily f ON sf.Family=f.Oid WHERE f.Designation='Женское' AND sf.Designation='Брюки' LIMIT 1),
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 17800, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='BR-002');

INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000014-0000-4000-8000-000000000014', 1014, 'BR-003', 'Брюки', NULL, 'Assets/Images/Products/Shop/BR-003-pants-white-summer.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  (SELECT sf.Oid FROM fin_articlesubfamily sf JOIN fin_articlefamily f ON sf.Family=f.Oid WHERE f.Designation='Женское' AND sf.Designation='Брюки' LIMIT 1),
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 13000, 1, 0, datetime('now'), datetime('now')
...
INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000015-0000-4000-8000-000000000015', 1015, 'SH-001', 'Шорты', NULL, 'Assets/Images/Products/Shop/SH-001-shorts-denim-love.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  ...
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 16800, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='SH-001');

INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000016-0000-4000-8000-000000000016', 1016, 'SK-001', 'Юбка', NULL, 'Assets/Images/Products/Shop/SK-001-skirt-black-classic.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
...
INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000017-0000-4000-8000-000000000017', 1017, 'DR-001', 'Платье', NULL, 'Assets/Images/Products/Shop/DR-001-dress-mustard-shirt.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  ...
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 20000, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='DR-001');

INSERT INTO fin_article (Oid, Ord, Code, Designation, BarCode, ButtonImage, Family, SubFamily, Type, Class, UnitMeasure, UnitSize, VATOnTable, VATDirectSelling, Price1, PriceWithVat, Disabled, CreatedAt, UpdatedAt)
SELECT 'c2000018-0000-4000-8000-000000000018', 1018, 'DR-002', 'Платье', NULL, 'Assets/Images/Products/Shop/DR-002-dress-floral-white.jpg',
  (SELECT Oid FROM fin_articlefamily WHERE Designation='Женское' LIMIT 1),
  (SELECT sf.Oid FROM fin_articlesubfamily sf JOIN fin_articlefamily f ON sf.Family=f.Oid WHERE f.Designation='Женское' AND sf.Designation='Платье' LIMIT 1),
  'edf4841e-e451-4c7b-9bd0-ee02860ba937', '6924945d-f99e-476b-9c4d-78fb9e2b30a3', '4c81aa20-98ec-4497-b740-165cdb5fa395', '18f564aa-7da5-4a1c-9091-8014638b818c',
  'cee00590-7317-41b8-af46-66560401096b', 'cee00590-7317-41b8-af46-66560401096b', 25000, 1, 0, datetime('now'), datetime('now')
WHERE NOT EXISTS (SELECT 1 FROM fin_article WHERE Code='DR-002');

-- ─── После импорта через Excel: только картинки (BarCode не трогаем) ──────────

UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/TOP-001-top-beige.jpg' WHERE Code='TOP-001';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/TS-001-tshirt-blue-glitter.jpg' WHERE Code='TS-001';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/BL-001-blouse-white-pearl.jpg' WHERE Code='BL-001';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/BL-002-blouse-print-rhinestone.jpg' WHERE Code='BL-002';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/BL-003-blouse-peplum-white.jpg' WHERE Code='BL-003';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/BL-004-blouse-abstract-blue.jpg' WHERE Code='BL-004';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/RS-001-shirt-stripe-blue.jpg' WHERE Code='RS-001';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/BK-001-wrap-hood-white.jpg' WHERE Code='BK-001';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/K2-001-suit-print-bw.jpg' WHERE Code='K2-001';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/K2-002-suit-white-summer.jpg' WHERE Code='K2-002';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/PJ-001-blazer-dark.jpg' WHERE Code='PJ-001';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/BR-001-pants-brown-vishnya.jpg' WHERE Code='BR-001';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/BR-002-pants-denim-marya.jpg' WHERE Code='BR-002';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/BR-003-pants-white-summer.jpg' WHERE Code='BR-003';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/SH-001-shorts-denim-love.jpg' WHERE Code='SH-001';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/SK-001-skirt-black-classic.jpg' WHERE Code='SK-001';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/DR-001-dress-mustard-shirt.jpg' WHERE Code='DR-001';
UPDATE fin_article SET ButtonImage='Assets/Images/Products/Shop/DR-002-dress-floral-white.jpg' WHERE Code='DR-002';
